...
class ShareToMinds_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'share-to-minds'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'share-to-minds'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'share-to-minds'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'share-to-minds'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'share-to-minds');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'share-to-minds'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'share-to-minds');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'share-to-minds'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'share-to-minds') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'share-to-minds');
            case 'false':
                return __('false', 'share-to-minds');

            case 'Administrator':
                return __('Administrator', 'share-to-minds');
            case 'Editor':
                return __('Editor', 'share-to-minds');
            case 'Author':
                return __('Author', 'share-to-minds');
            case 'Contributor':
                return __('Contributor', 'share-to-minds');
            case 'Subscriber':
                return __('Subscriber', 'share-to-minds');
            case 'Anyone':
                return __('Anyone', 'share-to-minds');
        }
        return $optionValue;
    }
